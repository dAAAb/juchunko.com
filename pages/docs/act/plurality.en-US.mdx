...
<YoutubeCard
  ...
  videoId="UtnFMoGtcxg"
  description="The Pop-up City experiment in Montenegro and various voting systems, along with an introduction to the Quadratic Funding mechanism, Zupass technology, and a discussion on how technology can promote the democratic process. It also shares JC's plans as a legislator. This marks Vitalik's first podcast interview conducted entirely in Chinese, showcasing his achievements in learning the language."
/>
</Cards>}
